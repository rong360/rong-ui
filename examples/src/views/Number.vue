<template>
	<div class="wrap">
		<div class="exp">
			...
			<rNumber :attrs="config0_0" :ref="config0_0.name"></rNumber>
			<rNumber 
				:attrs="config1" 
				:ref="config1.name" 
			...
			<rNumber :attrs="config3_3" :ref="config3_3.name"></rNumber>
			<rNumber :attrs="config6_6"></rNumber>
